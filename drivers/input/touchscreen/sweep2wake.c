...
static int input_dev_filter(struct input_dev *dev) {
	if (strstr(dev->name, "touch") ||
       strstr(dev->name, "synaptics_rmi4_i2c") || strstr(dev->name, "pantech_touch")|| strstr(dev->name, "%sfn%02x") || strstr(dev->name, "rmi_generic")
								|| strstr(dev->name, "sdmmc2_clk.gpio_130")|| strstr(dev->name, "rmi")|| strstr(dev->name, "rmidev")
								|| strstr(dev->name, "rmi0")|| strstr(dev->name, "sensor00")|| strstr(dev->name, "sensor00fn11")) {
		return 0;
	} else {
		return 1;
	}
